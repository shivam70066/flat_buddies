...
<section class="view-property">
   ...
   <div class="details">
      <div class="thumb">
         <div class="big-image">
            <img src="images/oloby2.jpg" alt="">
         </div>
         <div class="small-images">
            <img src="images/oloby2.jpg" alt="">
            <img src="images/obed1.jpg" alt="">
            <img src="images/obed2.jpg" alt="">
            <img src="images/olobby.jpg" alt="">
            <img src="images/oro.jpg" alt="">
         </div>
      </div>
      <h3 class="name">Omega (3BHK)</h3>
      <p class="location"><i class="fas fa-map-marker-alt"></i><span>Kharar, Punjab, India - 140301</span></p>
      <div class="info">
         <p><i class="fas fa-tag"></i><span>24k per Month</span></p>
         <p><i class="fas fa-user"></i><span>Munish (owner)</span></p>
         ...
         <p><i class="fas fa-calendar"></i><span>01-11-2023</span></p>
      </div>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-check"></i><span>Play ground</span></p>
